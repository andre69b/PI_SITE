...
{
    public class MyRealEstateReserveController : AbstractController
    {
        //
        // GET: /MyRealEstateReserve/
        [Authorize]
        public ActionResult Page(int id = 1, int ajax = 0)
        {
            ...
            Info info = new Info(rl.GetRealEstateRegisterByUserNameGeTByUserName(User.Identity.Name), id, Info.DEFAULT);
